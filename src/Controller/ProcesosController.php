...
class ProcesosController extends AppController
{
    ...
    public function planilla($id=null)
    {
        ...
        if($proceso->tipo=='Asignacion'&&!empty($proceso->asignaciones))
            $this->tipoasignacion($proceso,$solicitante,$supervisor,$encargado);
        elseif($proceso->tipo=='Devolucion'&&!empty($proceso->devoluciones))
            $this->tipodevolucion($proceso,$solicitante,$supervisor,$encargado);
        elseif (!empty($proceso->devoluciones)&&!empty($proceso->asignaciones))
            $this->tipomixto($proceso,$solicitante,$supervisor,$encargado);
        else{
            $this->Flash->error(__('Este proceso es irregular o tiene datos incompletos, fue imposible generar su planilla.'));
            return $this->redirect($this->referer());
        }
    ...
    protected function tipoasignacion($proceso,$solicitante,$supervisor,$encargado)
    {
        $phpWord = new PHPWord();
        ...
        $innercell11 =$innerrow1->addCell(3500, array('bgColor' => 'ffffff'))->addTextRun(array('spaceBefore'=>16,'spaceAfter' => 1,'size' => 8,'lineHeight'=>1.5));
        ...
        $innercell12 =$innerrow1->addCell(4000, array('bgColor' => 'ffffff'))->addTextRun(array('spaceBefore'=>16,'spaceAfter' => 1,'size' => 8,'lineHeight'=>1.5));
        ...
        $innercell13 =$innerrow1->addCell(3500, array('bgColor' => 'ffffff'))->addTextRun(array('spaceBefore'=>16,'spaceAfter' => 1,'size' => 8,'lineHeight'=>1.5));
        ...
        $innercell21=$innerrow2->addCell(3500, array('bgColor' => 'ffffff'))->addTextRun(array('spaceBefore'=>1,'spaceAfter' => 1,'size' => 8,'lineHeight'=>1.5));
        $innercell21->addText('Correo: ',array('name' => 'Arial','bold'=>true, 'size'=>9, 'valign' => 'left'));
        $innercell21->addText('???',array('name' => 'Arial', 'size'=>8, 'valign' => 'left'));
        $innercell22=$innerrow2->addCell(4000, array('bgColor' => 'ffffff'))->addTextRun(array('spaceBefore'=>1,'spaceAfter' => 1,'size' => 8,'lineHeight'=>1.5));
        $innercell22->addText('Supervisor: ',array('name' => 'Arial','bold'=>true, 'size'=>9, 'valign' => 'left'));
        $innercell22->addText('???',array('name' => 'Arial', 'size'=>8, 'valign' => 'left'));
        $innercell23=$innerrow2->addCell(3500, array('bgColor' => 'ffffff'))->addTextRun(array('spaceBefore'=>1,'spaceAfter' => 1,'size' => 8,'lineHeight'=>1.5));
        $innercell23->addText('Area: ',array('name' => 'Arial','bold'=>true, 'size'=>9, 'valign' => 'left'));
        $innercell23->addText('???',array('name' => 'Arial', 'size'=>8, 'valign' => 'left'));
        $innert3 = $cell->addTable(array('alignment' => JcTable::CENTER));
        $innerrow3=$innert3->addRow();
        $innercell31=$innerrow3->addCell(3500, array('bgColor' => 'ffffff'))->addTextRun(array('spaceBefore'=>1,'spaceAfter' => 1,'size' => 8,'lineHeight'=>1.5));
        $innercell31->addText('Gerencia: ',array('name' => 'Arial','bold'=>true, 'size'=>9, 'valign' => 'left'));
        $innercell31->addText('???',array('name' => 'Arial', 'size'=>8, 'valign' => 'left'));
        $innercell32=$innerrow3->addCell(4000, array('bgColor' => 'ffffff'))->addTextRun(array('spaceBefore'=>1,'spaceAfter' => 1,'size' => 8,'lineHeight'=>1.5));
        $innercell32->addText('Cargo: ',array('name' => 'Arial','bold'=>true, 'size'=>9, 'valign' => 'left'));
        $innercell32->addText('???',array('name' => 'Arial', 'size'=>8, 'valign' => 'left'));
        $innercell33=$innerrow3->addCell(3500, array('bgColor' => 'ffffff'))->addTextRun(array('spaceBefore'=>1,'spaceAfter' => 1,'size' => 8,'lineHeight'=>1.5));
        $innercell33->addText('Ubicación: ',array('name' => 'Arial','bold'=>true, 'size'=>9, 'valign' => 'left'));
        $innercell33->addText('???',array('name' => 'Arial', 'size'=>8, 'valign' => 'left'));
        $section->addTextBreak(1,array('spacing' => 240, 'size' => 1));
        $table = $section->addTable(array('borderSize' => 0, 'alignment' => JcTable::CENTER));
        ...
        $innercell21->addText('HERNANDEZ DANNY',array('name' => 'Arial', 'size'=>8, 'valign' => 'left'));
    ...
    protected function tipodevolucion($proceso,$solicitante,$supervisor,$encargado)
    {
        $phpWord = new PHPWord();
        $sectionStyle=array('pageSizeH'=>Converter::cmToTwip(27.94),'pageSizeW'=>Converter::cmToTwip(21.59));
        $section = $phpWord->addSection($sectionStyle);
    ...
    protected function tipomixto($proceso,$solicitante,$supervisor,$encargado)
    {
        $phpWord = new PHPWord();
        $sectionStyle=array('pageSizeH'=>Converter::cmToTwip(27.94),'pageSizeW'=>Converter::cmToTwip(21.59));
        $section = $phpWord->addSection($sectionStyle);
